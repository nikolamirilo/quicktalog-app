-- M00 perimeter close (Phase 0A of the Supabase Auth migration).
-- Apply only after the Phase 0A app and worker code has run on this environment for 24h with no app /rest/v1 traffic.
