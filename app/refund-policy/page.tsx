		...
		<>
			...
			<div className="max-w-3xl mx-auto px-4 py-36">
				<h1 className="text-3xl font-bold mb-6">
					Refund Policy for Quicktalog
				</h1>

				<p className="mb-4">
					At Quicktalog, we want you to be completely satisfied with your
					purchase. We offer a straight-forward refund policy to ensure your
					peace of mind.
				</p>
				...
				<ul className="list-disc list-inside space-y-2 mb-4">
					...
					<li>
						Renewals of subscriptions are generally non-refundable. Please
						manage your subscription settings before the renewal date if you
						wish to cancel.
					</li>
					<li>
