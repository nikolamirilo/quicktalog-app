  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-36">
        ...
        <p className="mb-4">
          This Privacy Policy describes how Quicktalog ("we," "us," or "our") collects, uses, and
          discloses your personal information when you use our software-as-a-service (SaaS)
          platform, Quicktalog (the "Service"). We are committed to protecting your privacy and
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          <li>
            <strong>Account Information:</strong> When you register for Quicktalog, we collect your
            name, email address, and password.
          </li>
          <li>
            <strong>Payment Information:</strong> For purchases, we use Paddle.com as our Merchant
            of Record. We do not directly store or process your credit card details. Paddle securely
            handles all payment transactions in compliance with PCI DSS standards. We receive
            limited information from Paddle about your transaction (e.g., subscription status,
            transaction ID) for order fulfillment and support.
          </li>
          <li>
            <strong>Usage Data:</strong> We collect information about how you use Quicktalog, such
            as the features you use, the actions you take, and the time, frequency, and duration of
            your activities. This helps us understand how our service is used and where we can
            improve.
          </li>
          <li>
            <strong>Technical Data:</strong> We automatically collect information about your device
            and browser, including IP address, browser type, operating system, and unique device
            identifiers.
          </li>
          <li>
            <strong>Communication Data:</strong> If you contact us, we'll keep records of our
            correspondence.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          ...
          <li>
            To communicate with you, including sending service updates, security alerts, and support
            messages.
          </li>
          <li>
            To monitor and analyze usage and trends to improve our marketing and product offerings.
          </li>
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          <li>
            <strong>Paddle.com:</strong> As our Merchant of Record, Paddle receives necessary
            information to process payments and manage your purchases.
          </li>
          <li>
            <strong>Service Providers:</strong> We may share data with third-party vendors,
            consultants, and other service providers who perform services on our behalf (e.g.,
            hosting, analytics, customer support). These providers are obligated to protect your
          ...
          <li>
            ...
            so by law or in response to valid requests by public authorities (e.g., a court order or
            government agency).
          </li>
          <li>
            <strong>Business Transfers:</strong> In connection with a merger, acquisition, or sale
            of assets, your information may be transferred as part of that transaction. We will
            notify you of any such transfer and choices you may have regarding your information.
          </li>
        </ul>
        ...
        <p className="mb-4">
          ...
          information. We use industry-standard encryption for data in transit and at rest where
          appropriate. While we strive to protect your personal information, no method of
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          ...
          <li>
            <strong>Objection to Processing:</strong> Object to the processing of your personal
            data.
          </li>
          <li>
            <strong>Data Portability:</strong> Request the transfer of your personal data to another
            party.
          </li>
          <li>
            <strong>Withdraw Consent:</strong> Withdraw consent at any time where we are relying on
        ...
        <p className="mb-4">
          Quicktalog uses cookies and similar tracking technologies to track activity on our Service
        ...
        <p className="mb-4">
          ...
          top of this Privacy Policy. You are advised to review this Privacy Policy periodically for
