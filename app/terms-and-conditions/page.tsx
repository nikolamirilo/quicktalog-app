    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-36">
        ...
        <p className="mb-4">
          ...
          mobile-friendly digital catalogs. By using our service, you agree to these terms. If you
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            ...
            payment. All transactions must be initiated by the buyer through our website's secure
            checkout process.
          </li>
          <li>
            For your security and PCI DSS compliance, we <strong>never</strong> store or have access
            to your credit card details. All payment information is securely processed by
            Paddle.com.
          </li>
          <li>
            Before you finalize a purchase, we'll clearly present the product or subscription plan
            you're buying, including the total price and any recurring billing details if it's a
            subscription. This ensures you know exactly what you're committing to.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            Every product and plan page on our website clearly details the features, capabilities,
            and any limitations of the Quicktalog service.
          </li>
          <li>
            We ensure that all product descriptions within our Paddle dashboard are consistent with
            what's displayed on our website, maintaining full compliance and transparency.
          </li>
          <li>
            If you have any questions or need clarification on a product's capabilities before
            purchasing, please contact our support team.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            Before completing your purchase, you'll have the opportunity to review and modify your
            order details in the shopping cart or checkout summary.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            To initiate a refund request, you may contact Paddle directly through their buyer
            support portal at{" "}
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            Upon successful completion of payment, you will receive immediate, uninterrupted access
            to the Quicktalog platform.
          </li>
          <li>
            Account activation details and onboarding instructions will be sent to your registered
            email address and displayed on the purchase success screen.
          </li>
          <li>
            Should you encounter any issues accessing your account or the platform immediately after
            purchase, please contact us without delay.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            We are committed to fair and ethical practices. We do not engage in misleading,
            deceptive, or unethical sales or marketing tactics.
          </li>
          <li>
            We do not sell any products or services that are listed on Paddle's unsupported products
            list or that violate any of Paddle's policies.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>
            Your credit card statement will clearly show "Quicktalog" as the transaction descriptor,
            making it easy to recognize your purchase. This can be configured in your Paddle
            dashboard under Checkout &rarr; Checkout Settings &rarr; Transactions.
          </li>
          <li>
            We commit to promptly notifying Paddle of any changes to our refund policy, product
            terms and conditions, or contact details, and we will update our website accordingly to
        ...
        <p>
          By using Quicktalog, you agree to be bound by these Terms & Conditions and any applicable
          local laws. If you do not agree with any part of these terms, please discontinue using the
          platform.
        </p>
