...
export default async function page() {
  ...
  if (userData && userData.pricing_plan.id > 1) {
    return (
      <div className="product font-lora min-h-screen">
        ...
        <div className="w-full min-h-screen px-2 md:px-8 pt-24 pb-12 bg-gradient-to-br from-product-background to-hero-product-background animate-fade-in">
          <div className="container mx-auto flex flex-col px-4 gap-8">
            <AiServicesFormSwithcer type="ocr_import" userData={userData} />
          </div>
        </div>
        <Footer />
      </div>
    ...
    return (
      <LimitsModal
        ...
        requiredPlan={
          userData.pricing_plan.next_plan == "Pro" ? "Growth" : userData.pricing_plan.next_plan
        }
      />
    )
  }
