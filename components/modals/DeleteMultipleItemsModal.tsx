      ...
      <DialogContent
        ...
        <DialogHeader className="pb-4">
          ...
          <DialogDescription className="text-product-foreground-accent">
            You have {catalogues.length} catalogues, but your plan allows only {maxAllowed}. Please
            select at least {requiredDeletions} catalogue{requiredDeletions > 1 ? "s" : ""} to
            delete.
            <br />
          ...
          <Button
            ...
            {isDeleting ? (
              ...
              <>
                ...
                Delete {selectedIds.length} Catalogue{selectedIds.length !== 1 ? "s" : ""}
              </>
            )}
          </Button>
        </DialogFooter>
