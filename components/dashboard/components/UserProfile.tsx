			...
			<div className="flex flex-col items-center md:flex-row md:items-center w-full gap-4 sm:gap-6 md:gap-8 z-10">
				<div className="relative flex-shrink-0 flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 xl:w-32 xl:h-32">
					{user.image ? (
						<img
							alt="Profile"
							className={`rounded-full ring-4 ring-product-primary shadow-lg object-cover ${size}`}
							height={128}
						...
						<div
							aria-hidden="true"
							className={`rounded-full ring-4 ring-product-primary shadow-lg bg-product-background-hover text-product-foreground flex items-center justify-center font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl ${size}`}
						>
