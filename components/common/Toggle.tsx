            ...
            <div
              ...
              {layouts.map((layoutOption) => (
                ...
                `}
                  ...
                  <span className="relative z-10 text-center leading-tight">{layoutOption.label}</span>
                  {layout === layoutOption.key && (
                    <div
          ...
          <div
            ...
            {themes.map((themeOption) => (
              <button
                ...
                style={{
                  borderColor: theme === themeOption.key ? 'var(--product-primary)' : 'var(--section-border)',
