export default function BrowserFrame({
	...
	return (
		<div
			className={`${isMobileView ? "max-w-[375px]" : "max-w-[1000px]"} w-full mx-auto transition-all duration-500 ease-in-out`}
		>
			{isMobileView ? (
				...
				<div
					className={`border border-gray-200 rounded-2xl overflow-hidden flex flex-col w-full h-[600px] shadow-2xl bg-white transform transition-all duration-500 ease-in-out relative`}
				>
					{/* Browser Top Bar */}
