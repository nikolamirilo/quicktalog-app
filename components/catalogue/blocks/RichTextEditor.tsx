...
export default function RichTextEditor({
    ...
    const ToolbarButton = ({
        ...
        return (
            <button
                className={`px-3 py-1.5 border border-gray-300 hover:bg-gray-100 transition-colors text-sm font-medium flex items-center justify-center ${isActive ? "bg-gray-200" : "bg-white"
                    }`}
                onClick={onClick}
        ...
        <div className={className}>
            {editable && (
                <div className="flex flex-wrap gap-1 mb-2 p-2 bg-gray-50 border border-gray-300 rounded">
                    ...
                    <button
                        className={`px-3 py-1.5 border border-gray-300 hover:bg-gray-100 transition-colors text-sm font-medium flex items-center justify-center ${showSource ? "bg-gray-200" : "bg-white"
                            }`}
