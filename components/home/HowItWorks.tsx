		...
		<motion.div className="h-full" variants={cardVariants}>
			<div
				className={clsx(
					...
					{
						"shadow-md hover:shadow-lg hover:scale-101 hover:-translate-y-0.5":
							!isHovered,
	...
	const steps: SimpleStep[] = [
		{
			...
			image: "/images/marketing/card1.svg",
		},
		{
			step: "2",
			...
			image: "/images/marketing/card2.svg",
		},
		{
			step: "3",
			title: "Publish & share",
			...
			image: "/images/marketing/card3.svg",
		},
	];
