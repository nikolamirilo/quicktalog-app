...
const PricingColumn: React.FC<PricingColumnProps> = ({
  ...
  const getFeatureList = (features: PricingPlan["features"]) => {
    return [
      ...
      features.ocr_ai_import == 0
        ? null
        : { text: `${features.ocr_ai_import} OCR AI imports per month`, type: "ocr-ai-import" },
  ...
  const getButtonText = () => {
    ...
    const currentTier = filteredTiers.find((t) => Object.values(t.priceId).includes(user.plan_id))
      ...
      <div
        ...
        <div className="p-6 flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div className="flex-grow">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {getFeatureList(tier.features).map((feature, index) => (
                <div key={index} className="flex items-start transition-all duration-300">
          ...
          <div className="flex-shrink-0 md:w-40">
            <Button
              variant={highlight || getButtonText() == "Upgrade" ? "cta" : "cta-secondary"}
