...
const Step4Branding: React.FC<Step4BrandingProps> = ({
  ...
  const getFieldExplanation = (field: string): string => {
    const explanations: { [key: string]: string } = {
      ...
      "footer-action-link":
        "A call-to-action button that appears in the footer of your catalogue. This can direct visitors to contact you, book services, or visit your main website.",
      "header-action-link":
        "A call-to-action button that appears in the header/navigation area of your catalogue. This provides easy access to important actions like booking or contacting you.",
      newsletter:
        "Enables a newsletter signup form in the footer of your catalogue. This helps you collect email addresses for marketing and customer communication.",
      "contact-information":
        "Contact details like email, phone, and social media links that will appear in the footer of your catalogue. This makes it easy for visitors to reach you.",
      partners:
        "Partner logos and information that will be displayed in the footer of your catalogue. This helps showcase business partnerships and adds credibility to your services.",
    }
