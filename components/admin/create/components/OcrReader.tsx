		...
		<div className="flex flex-col items-center text-product-foreground min-h-screen">
									...
									<div className="text-center">
										...
										{OCRImageData.isProcessed && (
											<div className="flex justify-center">
												{OCRImageData.confidence !== undefined &&
												OCRImageData.confidence > 0 ? (
													<span
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
				<div className="p-6 rounded-xl border border-product-border bg-hero-product-background shadow-product">
					<h3 className="font-bold text-xl mb-4 text-product-foreground">
						Processing Summary
					</h3>
					<div className="space-y-2">
						...
						{isSubmitting && (
							<p className="text-green-600">Creating service catalogue...</p>
						)}
					</div>
				</div>

				<div className="p-6 rounded-xl border border-product-border bg-hero-product-background shadow-product">
					<h3 className="font-bold text-xl mb-4 text-product-secondary">
						Extracted Text
					</h3>
