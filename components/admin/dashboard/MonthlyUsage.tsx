...
const MonthlyUsage = ({ data, pricingPlan }: { data: Usage; pricingPlan: PricingPlan }) => {
  const trafficUsage = {
    data: [
    ...
    <div className="max-w-6xl space-y-8 bg-gradient-to-br from-product-background to-hero-product-background  rounded-3xl">
      ...
      <div className="space-y-4">
        <h2
          ...
          <FiBarChart2 className="text-product-icon font-lora w-6 h-6 sm:w-8 sm:h-8" /> Usage
          Overview
        </h2>
            ...
            <Card
              ...
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-product-foreground">{chart.title}</h3>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-6 border-t border-product-border">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-product-foreground-accent">Used</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-product-foreground">
                      {chart.data[1].toLocaleString()}
                    </div>
                    <div className="text-sm text-product-foreground-accent">Remaining</div>
                  </div>
                </div>
              </CardContent>
            </Card>
