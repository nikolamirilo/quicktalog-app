        ...
        <Container style={container}>
          ...
          <Section style={messageSection}>
            ...
            <Text style={messageText}>
              {getContextMessage()} Your feedback helps us make Quicktalog better for everyone.
            </Text>
          </Section>
          ...
          <Section style={ratingSection}>
            ...
            <Text style={ratingSubtitle}>Please rate your experience on a scale of 1-10:</Text>
          ...
          <Section style={additionalSection}>
            ...
            <Text style={additionalText}>
              Click any rating above to open our feedback form where you can share more detailed
              thoughts, suggestions, or report any issues you encountered.
            </Text>
            ...
            <div style={benefitsList}>
              <div style={benefitItem}>
                ...
                <div style={benefitContent}>
                  ...
                  <Text style={benefitDescription}>
                    Your insights help us prioritize new features and improvements.
                  </Text>
                </div>
              </div>
              ...
              <div style={benefitItem}>
                ...
                <div style={benefitContent}>
                  ...
                  <Text style={benefitDescription}>
                    Help us build the features that matter most to you and your business.
                  </Text>
                </div>
              </div>
          ...
          <Section style={privacySection}>
            <Text style={privacyText}>
              <strong>Privacy:</strong> Your feedback is completely anonymous and will only be used
              to improve our platform. We never share personal information.
            </Text>
          </Section>
          ...
          <Section style={footer}>
            <Text style={footerText}>Thank you for helping us make Quicktalog better!</Text>
