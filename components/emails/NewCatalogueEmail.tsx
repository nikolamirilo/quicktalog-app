        ...
        <Container style={container}>
          ...
          <Section style={linkSection}>
            ...
            <Text style={contentText}>
              Share this link with your customers to let them browse your catalog:
            </Text>
          ...
          <Section style={qrSection}>
            ...
            <Text style={contentText}>
              Use this QR code to make your catalog easily accessible. Customers can simply scan it
              with their phone camera to view your catalog instantly.
            </Text>
            ...
            <Text style={qrNote}>
              Print this QR code on business cards, flyers, or display it in your store for easy
              access.
            </Text>
          </Section>
          ...
          <Section style={embedSection}>
            ...
            <Text style={contentText}>
              Want to embed your catalog directly into your website? Use this HTML code:
            </Text>
            ...
            <Text style={codeNote}>
              Copy and paste this code into your website to embed your catalog as a full-screen
              overlay.
            </Text>
          </Section>
          ...
          {analyticsUrl && (
            <Section style={analyticsSection}>
              ...
              <Text style={contentText}>
                Monitor how your catalog is performing with detailed analytics. See how many people
                are viewing your catalog, which items are most popular, and more.
              </Text>
            ...
            <div style={tipsList}>
              <div style={tipItem}>
                ...
                <div style={tipContent}>
                  ...
                  <Text style={tipDescription}>
                    Post your catalog link on your social media profiles to reach more customers.
                  </Text>
                </div>
              </div>
              ...
              <div style={tipItem}>
                ...
                <div style={tipContent}>
                  ...
                  <Text style={tipDescription}>
                    Regularly update your catalog with new products, prices, and seasonal offerings.
                  </Text>
                </div>
              </div>
              ...
              <div style={tipItem}>
                ...
                <div style={tipContent}>
                  ...
                  <Text style={tipDescription}>
                    Check your analytics regularly to understand what your customers are most
                    interested in.
                  </Text>
                </div>
              </div>
          ...
          <Section style={footer}>
            <Text style={footerText}>Need help or have questions? We're here to support you!</Text>
            ...
            <div style={footerLinks}>
              ...
              <Link href={`${process.env.NEXT_PUBLIC_BASE_URL!}/help`} style={footerLink}>
                Help Center
              </Link>
              <span style={footerSeparator}>•</span>
