    ...
    variants: {
      variant: {
        ...
        cta: `
          ...
          bg-product-primary hover:bg-product-product-primary-accent text-product-foreground shadow-lg hover:shadow-xl
        ...
        `,
        header: `
          text-black bg-product-primary hover:bg-product-product-primary-accent px-8 py-3 transition-colors
        `,
        "header-mobile": `
          text-black bg-product-primary hover:bg-product-product-primary-accent px-5 py-2 block w-fit
        `,
        contact: `
        ...
        "file-action": `
          ...
          focus:outline-none focus:ring-2 focus:ring-product-product-primary-accent focus:ring-opacity-50
        `,
        nav: `
